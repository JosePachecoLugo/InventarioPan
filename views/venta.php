    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form method="post" action="agregarAlCarrito.php" id="formBusqueda">
                ...
                <input autocomplete="off" width="100%" autofocus class="form-control" name="codigo" required type="text" id="codigo" placeholder="Escanea o Escribe el código..." required>
            </form>
            <br>
...
document.getElementById('procesarVenta').addEventListener('click', function() {
    ...
    const formHTML = `
        <form id="ventaForm" class="mt-3" action="terminarVenta.php" method="POST" onsubmit="return validarFormulario()">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cantidadPagada" name="cantidadPagada" placeholder="Ingrese la cantidad" required>
            </div>
            <div class="form-group">
    ...
    const totalVenta = document.getElementById('cantidadPagada').value;

    // Actualizar la cantidad vendida en la base de datos
    actualizarCantidadEnBD(codigo, cantidadVendida, totalVenta);
...
function actualizarCantidadEnBD(codigo, cantidadVendida, totalVenta) {
